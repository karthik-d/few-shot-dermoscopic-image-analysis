...
Model building, experiments, references and source code for the research work on skin image analysis that draws on meta-learning to improve performance in the low data and imbalanced data regimes. 
